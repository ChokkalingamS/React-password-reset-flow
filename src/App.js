...
const [open, setOpen] = useState(false);
  ...
  const {handleChange,handleBlur,handleSubmit,errors,values,touched}=useFormik({
    ...
    validate:validation,
    onSubmit:(userdata)=>signUp(userdata).then((x)=>(x===200) && handleClickOpen())
  })
  ...
  return ( <Card variant="outlined" id="signup">
    <form className="signup" onSubmit={handleSubmit}>
      
      <TextField fullWidth id="Firstname" name="Firstname" variant="standard"
      error={errors.Firstname && touched.Firstname}  value={values.Firstname}
      helperText={errors.Firstname && touched.Firstname &&errors.Firstname}
      type="text" onInput={handleChange} onChange={(e)=>setName(e.target.value)} onBlur={handleBlur} label="Firstname"  /><br/>
      
      <TextField fullWidth id="Lastname" name="Lastname"  error={errors.Lastname && touched.Lastname}
      helperText={errors.Lastname && touched.Lastname &&errors.Lastname} value={values.Lastname}
      variant="standard" type="text" onInput={handleChange} onBlur={handleBlur} label="Lastname"/><br/>
      
      <TextField fullWidth id="Mailid"  name="Mailid"  error={errors.Mailid && touched.Mailid} value={values.Mailid}
      helperText={errors.Mailid&& touched.Mailid &&errors.Mailid} variant="standard" type="text" 
      onInput={handleChange} onBlur={handleBlur} label="Mail ID"/><br/>
      
      <TextField fullWidth id="Password" name="Password"  error={errors.Password && touched.Password} value={values.Password}
      helperText={errors.Password && touched.Password &&errors.Password} variant="standard"  type="text" onInput={handleChange} 
      onBlur={handleBlur}label="Password"/><br/><br/>
      
      <Button  fullWidth type="submit" variant="outlined">Get Started</Button><br/>
      ...
      <Button  fullWidth type="submit" onClick={()=>history.push('/login')}variant="contained" color="success" >Login</Button><br/>
...
function Login()
{
  ...
  return(<Card id="login" variant="outlined">
      <form  onSubmit={handleSubmit}>
      <p style={{fontWeight:500,fontSize:'1.5rem'}}>W E L C O M E B A C K!!!</p>

      <TextField type="text"  fullWidth id="Mailid" name="Mailid" variant="standard" 
      error={errors.Mailid && touched.Mailid} value={values.Mailid}
      helperText={errors.Mailid&& touched.Mailid &&errors.Mailid} 
      onInput={handleChange} onBlur={handleBlur} label="Mail ID"/><br/><br/>

      <TextField type="text" fullWidth id="Password" name="Password" variant="standard"
       error={errors.Password && touched.Password} value={values.Password}
      helperText={errors.Password&& touched.Password &&errors.Password}
       onInput={handleChange} onBlur={handleBlur}  label="Password"/><br/><br/>
      
      <Button type="submit" fullWidth  variant="contained" color="primary" >Login</Button><br/><br/>

      <Button type="submit" style={{marginLeft:'19.4rem'}} onClick={()=>history.push('/forgotpassword')} 
      variant="contained" color="error" >Forgot Password</Button>
      </form>
  </Card>)
}
...
function Forgotpassword()
{
  ...
  const {handleChange,handleBlur,handleSubmit,errors,values,touched}=useFormik({
    ...
    validate:validation,
    onSubmit:(userdata)=>forgot(userdata).then((x)=>(x===200)&&history.push('/updatepassword'))
  })
  ...
  return(<Card id="forgotpage">
    <form onSubmit={handleSubmit}>
     <p style={{fontWeight:500,fontSize:'1.5rem'}}>F O R G O T P A S S W O R D</p>
    
    <TextField type="text"  error={errors.Mailid && touched.Mailid} value={values.Mailid}
      helperText={errors.Mailid&& touched.Mailid &&errors.Mailid} onInput={handleChange} onBlur={handleBlur} 
      fullWidth id="Mailid" name="Mailid"label="Mail ID"  variant="standard"/><br/><br/>
    
    <Button type="submit" fullWidth label="Password" variant="contained" color="primary">Submit</Button>
  </form>
  </Card>)
...
// Loading Page
  return <div><img style={{marginLeft:"16rem"}} src="https://cdn.dribbble.com/users/108183/screenshots/2301400/spinnervlll.gif" alt="loading"></img></div>;
}
...
//  then the password will be updated
  ...
  return (<Card id="changepassword">
    <form onSubmit={handleSubmit}>
     <p style={{fontWeight:500,fontSize:'1.5rem'}}>C H A N G E P A S S W O R D!!!</p>

    <TextField type="text" fullWidth label="Password" id="Password" name="Password" variant="standard" 
     error={errors.Password && touched.Password}  value={values.Password}
     helperText={errors.Password && touched.Password && errors.Password} onInput={handleChange} onBlur={handleBlur}/><br/><br/>

    <Button type="submit"  fullWidth variant="contained" color="success" >Update Password</Button>
    </form>
  </Card>) 
}
